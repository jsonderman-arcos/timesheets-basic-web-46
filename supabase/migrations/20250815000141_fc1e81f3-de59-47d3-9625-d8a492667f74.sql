-- Create sample profiles without auth constraints and add the remaining data
...
SELECT 
  t.id,
  -- Generate realistic coordinates around a central location
