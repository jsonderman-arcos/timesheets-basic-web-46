...
BEGIN
    ...
    LOOP
        ...
        IF crew_index <= daily_crew_count THEN
            ...
            FOR i IN 1..31 LOOP
                target_date := DATE '2025-08-01' + (i - 1);
        ...
        ELSE
            ...
            -- Create entries for Wednesdays in August 2025: 6th, 13th, 20th, 27th
            INSERT INTO time_entries (
                crew_id, date, start_time, end_time, hours_regular, hours_overtime, 
                work_description, status, created_at
            ) VALUES 
                (crew_record.id, '2025-08-06', '08:00:00', '17:00:00', 9.0, 0.0, 'Weekly scheduled maintenance', 'submitted', NOW()),
                (crew_record.id, '2025-08-13', '08:00:00', '17:00:00', 9.0, 0.0, 'Weekly scheduled maintenance', 'submitted', NOW()),
                (crew_record.id, '2025-08-20', '08:00:00', '17:00:00', 9.0, 0.0, 'Weekly scheduled maintenance', 'submitted', NOW()),
                (crew_record.id, '2025-08-27', '08:00:00', '17:00:00', 9.0, 0.0, 'Weekly scheduled maintenance', 'submitted', NOW());
        END IF;
    END LOOP;
