...
BEGIN
    ...
    LOOP
        ...
        ELSE
            ...
            -- Create entries for Wednesdays in August 2025
            -- August 2025: 6th, 13th, 20th, 27th are Wednesdays
            FOR week_day IN ARRAY[6, 13, 20, 27] LOOP
                target_date := DATE '2025-08-01' + (week_day - 1);
